...
let isFormModified = false; //Pop up for when changing element without saving
...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  if (document.getElementById('home')) {
    ...
    if (document.getElementById('home')) {
      ...
      document.getElementById('userFollowing').addEventListener('click', function () {
        const div = document.getElementById('followingDiv')
        ...
        gsap.set(div, { transformOrigin: 'top center' });

        // Animate in with 3D rotate and fade
        gsap.fromTo(div,
      ...
      document.getElementById('closeFollowing').addEventListener('click', function () {
        ...
        // Animate out with 3D rotate and fade
        gsap.to(div, {
          rotationX: -90,
          opacity: 0,
          duration: 0.4,
      ...
      document.getElementById('userFollowers').addEventListener('click', function () {
        const div = document.getElementById('followersDiv')
        document.body.classList.add('overflow-hidden')
          ...
          userTable.innerHTML += `
            <div style="" class="border bg-body-secondary d-flex align-items-center gap-3 p-3 rounded m-2 transitionAll" >
              ...
              <div class="flex-1">
                ...
                <p style="" class="fs-6 my-1 fw-lighter">${userEmail}</p>
              </div>
            </div>
          `;
        }
  ...
  <h4>Not found!</h4>
        ...
        for (let i = 0; i < arrayProjects.length; i++) {
         ...
         <div class="d-flex flex-column align-items-start text-start rounded w-100 h-auto m-1" style="">

           <div class="d-flex w-100 justify-content-center form-check form-switch mb-3">
            <input title="Preview" class="form-check-input cursor-pointer" style="" type="checkbox" id="checkNativeSwitch-${userSlug}-${projectSlug}">
            </div>
...
<!-- User Info -->
    <div style="" class="mt-auto ms-auto me-auto w-100 user-info-mdo">
      ...
      <div class="text-break">
        <a href="member.html?slug=${userSlug}" class="m-0 fw-bold fs-6 text-decoration-none" style="">${userName}</a>
        <p class="m-0 fw-lighter fs-6" style="">${userEmail}</p>
      </div>
    </div>
      ...
      <div class="text-break">
        ...
        <p class="m-0 fw-lighter fs-6" style="">${userEmail}</p>
         ...
         <div class="d-flex text-center align-items-center w-100 bg-transparent mt-1 rounded">
               <a class="btn btn-primary" title="Like" project-id="${projectSlug}" m-1" href="#" id="heartToggle-${userSlug}-${projectSlug}">
                  <svg id="heartIcon-${userSlug}-${projectSlug}" local="https://icons.getbootstrap.com/icons/heart/" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
                         ...
                         <!-- Description Button -->
<button id="openDescription-${userSlug}-${projectSlug}" class="btn btn-success m-1" title="Description">
...
<path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/>
                ...
                <div class="d-flex justify-content-center align-items-center flex-row gap-1 text-center p-1">
      
                <button type="button" title="Views" class="btn btn-secondary">
  ...
  <path d="M2 13c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4"/>
                  ...
                  <p class="m-0">${projectView}</p>
                   ...
                   <div class="d-flex justify-content-center align-items-center flex-row gap-1 text-center p-1">
              <button type="button" title="Likes" class="btn btn-secondary">      
...
`
        ...
        `;
          ...
          openDescriptionBtn.addEventListener('click', () => {
            ...
            gsap.set(markdownOverlay, { display: 'flex' }); // Make visible before fading in
            gsap.fromTo(markdownOverlay,
              { opacity: 0 },
          ...
          closeDescriptionBtn.addEventListener('click', () => {
            // Fade out, then hide and clean up
            gsap.to(markdownOverlay, {
              opacity: 0,
              duration: 0.5,
              ease: 'power2.in',
              onComplete: () => {
                gsap.set(markdownOverlay, { display: 'none' }); // Hide after fade
          ...
          heartToggle.addEventListener('click', async function (e) {
            ...
            if (isFilled) {
              ...
              if (result == false) {
                showMessagePopup('An error occured or create an account/log in to interact', false)
                showErrorPopup()
              }
              else {
      ...
      async function listFollowing() {
        try {
          ...
          if (response.ok) {
           ...
           <div class="col-12 w-100 p-2 col-sm-6 col-md-4 col-lg-3">
      <div
        ...
        <!-- Avatar -->
        <img
          src="${serverStorage}${element.photo}"
          alt="${element.name}"
          id="image-${element.email}"
          class="rounded-circle mb-2 mb-sm-0 me-sm-3 object-fit-cover"
          width="154" height="154">
        
        <!-- Info -->
        <div class="flex-grow-1">
          <h6
            id="name-${element.slug}"
            class="mb-1 text-truncate">
            ${element.name}
          </h6>
          <p
            id="link-${element.email}"
            class="mb-2 text-muted small text-break">
            ${element.email}
          </p>
          <a
            href="member.html?slug=${element.slug}"
            class="d-inline-block text-primary fw-semibold text-decoration-none small">
            View Profile
          </a>
        </div>

        <!-- Follow -->
        <a title="Follow" class="nav-link" href="#" id="heartToggle">
          <svg id="heartIcon" local="https://icons.getbootstrap.com/icons/heart-fill/" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
  ...
  if (document.getElementById('loginForm')) {
    document.getElementById('loginForm').addEventListener('submit', async function (e) {
      ...
      if (document.getElementById('email').value !== document.getElementById('email').value.trim().replace(/\s+/g, "")) {
        showMessagePopup('Email must not contain spaces', false)
        return;
      }

      if (document.getElementById('password').value !== document.getElementById('password').value.trim().replace(/\s+/g, "")) {
        showMessagePopup('Password must not contain spaces', false)
        return;
      }
  ...
  if (document.getElementById('registerForm')) {
    document.getElementById('registerForm').addEventListener('submit', async function (e) {
      ...
      if (document.getElementById('name').value !== document.getElementById('name').value.trim()) {
        showMessagePopup('Name must not contain leading or trailing spaces', false)
        return;
      }
      ...
      try {
        ...
        if (response.ok) {
          showMessagePopup('Registration successful! Please check your email and verify your account', true);
          document.getElementById('message').innerText = `${data.message}`;
        } else {
          document.getElementById('message').innerText = `${data.message}: ${data.error}` || 'An unknown error occurred';
          showErrorPopup()
  ...
  if (document.getElementById('profileForm')) {
    ...
    document.getElementById('profileForm').addEventListener('submit', async function (e) {
      ...
      if (document.getElementById('preview').src == "") {
        showMessagePopup('You must upload a photo', false)
        return;
      }
      ...
      try {
        ...
        if (response.ok) {
          showMessagePopup('Updating successfully! If you changed your email, please consider validating the new email', true);
          showSuccessPopup()
        } else {
          document.getElementById('message').innerText = `${data.message}: ${data.error}` || 'An unknown error occurred';
          showErrorPopup()
    ...
    document.getElementById('changePasswordForm').addEventListener('submit', async function (e) {
      ...
      try {
        ...
        if (response.ok) {
          showMessagePopup('Password changed successfully', true);
  ...
  <path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/>
                          ...
                          <!-- Edit Button -->
  <button title="Edit" id="edit-${userSlug}-${projectSlug}" class="btn btn-secondary m-1">
  ...
  <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001m-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708z"/>
                          ...
                          <!-- Delete Button -->
  <button title="Delete" id="delete-${userSlug}-${projectSlug}" class="btn btn-danger m-1">
  ...
  if (document.getElementById('create')) {
    isFormModified = true
    //Trigger when user changes input/form after leaving window
    verifyInputFormChangesPopUp()
...
div {
  ...
  font-weight: 200;
      ...
      document.getElementById('aboutLink').addEventListener('click', function () {
        ...
        // Reset transform origin
        gsap.set(about, { transformOrigin: 'top center' });
      ...
      document.getElementById('descriptionLink').addEventListener('click', function () {
        ...
        description.style.pointerEvents = 'all'; // Enable interactions
        gsap.set(description, { transformOrigin: 'top center' }); // Set pivot point
      ...
      document.getElementById('closeDescription').addEventListener('click', function () {
        ...
        gsap.to(description, {
          ...
          ease: 'power2.in',
          onComplete: () => {
            description.style.pointerEvents = 'none'; // Disable interaction after exit
          }
        });
      });
      ...
      document.getElementById('photoLink').addEventListener('click', function () {
        ...
        gsap.set(photo, { x: 100, opacity: 0 }); // Start off-screen to the right
      ...
      document.getElementById('tagsLink').addEventListener('click', function () {
        ...
        gsap.set(tag, { scale: 0.95, opacity: 0, filter: 'blur(8px)' });
    ...
    document.getElementById('editForm').addEventListener('submit', async function (e) {
      ...
      if (document.getElementById('projectNameForm').value.trim() == "") {
        showMessagePopup('Name must not be blank', false)
        return;
      }

      if (document.getElementById('projectDescriptionForm').value.trim() == "") {
        showMessagePopup('Description must not be blank', false)
        return;
      }

      if (document.getElementById('javascriptForm').value.trim() == "") {
        showMessagePopup('Javascript must not be blank', false)
        return;
      }

      if (document.getElementById('cssForm').value.trim() == "") {
        showMessagePopup('CSS must not be blank', false)
        return;
      }

      if (document.getElementById('htmlForm').value.trim() == "") {
        showMessagePopup('HTML must not be blank', false)
        return;
      }

      if (document.getElementById('cover').src.trim() == "") {
        showMessagePopup('Photo must not be blank', false)
        return;
      }

      if (document.getElementById('tagsProjectText').textContent.trim() == "") {
        showMessagePopup('Tag must not be blank', false)
        return;
      }
      ...
      try {
        ...
        if (response.ok) {
          showMessagePopup('Created successfully', true)
          showSuccessPopup()
        } else {
          showErrorPopup()
        }
  ...
  <path fill-rule="evenodd" d="M6.5 3a.5.5 0 0 1 .5.5V6h2.5a.5.5 0 0 1 0 1H7v2.5a.5.5 0 0 1-1 0V7H3.5a.5.5 0 0 1 0-1H6V3.5a.5.5 0 0 1 .5-.5"/>
    ...
    document.getElementById('editForm').addEventListener('submit', async function (e) {
      ...
      try {
        ...
        if (response.ok) {
          showMessagePopup('Edited successfully', true)
          showSuccessPopup()
        } else {
          showErrorPopup()
        }
  ...
  if (document.getElementById('userProfileMember')) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        document.body.style.backgroundImage = `url(${serverStorage}${data.user.photo})`;
...
function showMessagePopup(message, success) {
  // Remove existing modal if already present
  const existing = document.getElementById('dynamicMessageModal');
  let buttonColor = ""
  let buttonInnerMessage = ""
  if (success) {
    buttonColor = 'success'
    buttonInnerMessage = `
    <svg xmlns="http://www.w3.org/2000/svg" local="https://icons.getbootstrap.com/icons/patch-check/" width="16" height="16" fill="currentColor" class="bi bi-patch-check" viewBox="0 0 16 16">
  ...
  <path d="m10.273 2.513-.921-.944.715-.698.622.637.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.636a2.89 2.89 0 0 1 4.134 0l-.715.698a1.89 1.89 0 0 0-2.704 0l-.92.944-1.32-.016a1.89 1.89 0 0 0-1.911 1.912l.016 1.318-.944.921a1.89 1.89 0 0 0 0 2.704l.944.92-.016 1.32a1.89 1.89 0 0 0 1.912 1.911l1.318-.016.921.944a1.89 1.89 0 0 0 2.704 0l.92-.944 1.32.016a1.89 1.89 0 0 0 1.911-1.912l-.016-1.318.944-.921a1.89 1.89 0 0 0 0-2.704l-.944-.92.016-1.32a1.89 1.89 0 0 0-1.912-1.911z"/>
    ...
    buttonColor = 'danger'
    buttonInnerMessage = `
    <svg xmlns="http://www.w3.org/2000/svg" local="https://icons.getbootstrap.com/icons/x-octagon/" width="16" height="16" fill="currentColor" class="bi bi-x-octagon" viewBox="0 0 16 16">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-${buttonColor}" data-bs-dismiss="modal">${buttonInnerMessage}</button>
          </div>
        </div>
      </div>
    </div>
...
function verifyInputFormChangesPopUp() {
  // Example: mark changes
